...
REPORTS = [
    dict(
        ...
        discipline="psy",
        authors=[
            {"name": "J. Okafor", "affiliation": "Department of Psychology, Lagos State University",
             "corresponding": True, "email": "j.okafor@lsu.example"},
            {"name": "R. Beaumont", "affiliation": "School of Education, University of Bristol"},
        ],
        date="2026-03-14",
    ...
    dict(
        ...
        discipline="cogsci",
        authors=[
            {"name": "L. Meunier", "affiliation": "Laboratoire de Sciences Cognitives, Universite de Lyon",
             "corresponding": True, "email": "l.meunier@univ-lyon.example"},
        ],
        date="2026-01-22",
    ...
    dict(
        ...
        discipline="neuro",
        authors=[
            {"name": "R. Ionescu", "affiliation": "Department of Neuroscience, University of Bucharest",
             "corresponding": True, "email": "r.ionescu@unibuc.example"},
            {"name": "P. Aldana", "affiliation": "Independent researcher"},
            {"name": "K. Mbeki", "affiliation": "Centre for Cognitive Neuroscience, University of Nairobi"},
        ],
        date="2025-11-08",
    ...
    dict(
        ...
        discipline="physics",
        authors=[
            {"name": "A. Kowalczyk", "affiliation": "Institute of Physical Chemistry, Polish Academy of Sciences",
             "corresponding": True, "email": "a.kowalczyk@ichf.example"},
        ],
        date="2025-09-30",
    ...
    dict(
        ...
        discipline="chem",
        authors=[
            {"name": "S. Haddad", "affiliation": "Department of Chemistry, American University of Beirut",
             "corresponding": True, "email": "s.haddad@aub.example"},
        ],
        date="2025-08-17",
    ...
    dict(
        ...
        discipline="bio",
        authors=[
            {"name": "T. Nakashima", "affiliation": "Department of Molecular Biology, Kyoto University",
             "corresponding": True, "email": "t.nakashima@kyoto-u.example"},
            {"name": "E. Solberg", "affiliation": "Independent researcher"},
        ],
        date="2025-06-02",
    ...
    dict(
        ...
        discipline="cs",
        authors=[
            {"name": "D. Alvarado", "affiliation": "Independent researcher",
             "corresponding": True, "email": "d.alvarado@rep0rt.example"},
        ],
        date="2026-02-10",
    ...
    dict(
        ...
        discipline="stat",
        authors=[
            {"name": "M. Petrov", "affiliation": "Department of Statistics, Sofia University",
             "corresponding": True, "email": "m.petrov@uni-sofia.example"},
        ],
        date="2025-12-05",
    ...
    dict(
        ...
        discipline="econ",
        authors=[
            {"name": "C. Whitfield", "affiliation": "Department of Economics, University of Manchester",
             "corresponding": True, "email": "c.whitfield@manchester.example"},
            {"name": "N. Osei", "affiliation": "Independent researcher"},
        ],
        date="2025-10-19",
    ...
    dict(
        ...
        discipline="ling",
        authors=[
            {"name": "F. Adeyemi", "affiliation": "Department of Linguistics, University of Ibadan",
             "corresponding": True, "email": "f.adeyemi@ui.example"},
        ],
        date="2025-07-25",
